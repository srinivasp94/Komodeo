...
public class SearchCommunityMembersAdapter extends RecyclerView.Adapter<SearchCommunityMembersAdapter.ViewHolder> {
    private Context context;
    private List<SearchCommunityPojo.CommunityBean> responseBeans;

    public SearchCommunityMembersAdapter(CommunityActivity communityActivity, List<SearchCommunityPojo.CommunityBean> responseBeans) {
    ...
    @NonNull
    @Override
    public SearchCommunityMembersAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_community, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SearchCommunityMembersAdapter.ViewHolder viewHolder, int i) {
