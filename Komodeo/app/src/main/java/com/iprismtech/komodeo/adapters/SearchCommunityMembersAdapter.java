...
public class SearchCommunityMembersAdapter extends RecyclerView.Adapter<SearchCommunityMembersAdapter.ViewHolder> {
    ...
    private List<SearchCommunityPojo.ResponseBean> responseBeans;

    public SearchCommunityMembersAdapter(CommunityActivity communityActivity, List<SearchCommunityPojo.ResponseBean> responseBeans) {
