...
public class DiscussionsPojo {
    ...
    public static class ResponseBean {
         ...
         * profile_pic : storage/profile_pics/5c98c71cd440f.png
         * time : 4405
